...
const content = {
  en: {
    ...
    footer: { rights: '\u00a9 2026 Dom Analytics. All rights reserved.', privacy: 'Privacy Policy', terms: 'Terms of Service' },
  },
  hr: {
    ...
    mission: { label: 'NA\u0160A MISIJA', title: 'Premostiti jaz izme\u0111u podataka i odluka', text: 'Vjerujemo da svaki posao zaslu\u017euje pristup <em>AI-u i analitici svjetske klase</em>. Na\u0161a misija je demokratizirati inteligentnu tehnologiju \u2014 u\u010diniti je dostupnom, prakti\u010dnom i transformativnom za organizacije svih veli\u010dina. Ne gradimo samo rje\u0161enja. Gradimo <em>konkurentske prednosti</em>.' },
    ...
    story: { label: 'NA\u0160A PRI\u010cA', title: 'Od analiti\u010dara podataka do AI tvrtke',
    ...
    footer: { rights: '\u00a9 2026 Dom Analytics. Sva prava pridr\u017eana.', privacy: 'Pravila privatnosti', terms: 'Uvjeti kori\u0161tenja' },
  },
};
            ...
            {t.numbers.items.map((n, i) => (
              <div key={i} className="number-item">
                <div className="number-value">
                  <AnimatedCounter value={n.value} suffix={n.suffix} duration={2000 + i * 300} />
                </div>
