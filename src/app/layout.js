...
export default function RootLayout({ children }) {
  const jsonLd = {
    ...
    sameAs: ['https://www.linkedin.com/company/dom-analytics'], foundingDate: '2023',
  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script id="google-analytics" strategy="afterInteractive">{`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-RBG2NPZH10');gtag('config','AW-18058242847');`}</Script>
